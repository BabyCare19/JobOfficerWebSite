...
namespace JobOfficerWebsite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // add context to deail with data from database
        ...
        {
            //to not display role Administrator in register page write this condition
            ///Where(m =>!m.Name.Contains("Administrator")
            ViewBag.UserType = new SelectList(context.Roles.Where(m => !m.Name.Contains("Admins")).ToList(),
                                                    "Name", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ///////add this to add in table UserRole
                    //
        ...
        public ActionResult EditProfile()
        {
            ...
            var user = context.Users.Where(a => a.Id == UserId).SingleOrDefault();
